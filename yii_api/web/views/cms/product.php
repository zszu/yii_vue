...
<div class="elem_quote_search">
    <div class="inline">
        <?= Html::a('添加', ['admin/product-edit'], ['class' => 'default_btn btn_add']) ?>
    </div>
    <div class="inline pull-right">
        <?= Html::a('分类管理', ['admin/type' , 'name'=>'product'], ['class' => 'btn default_btn btn-lg']);?>
    </div>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'filter' => Yii::$app->params['list']['qy_ty'],
            ],
